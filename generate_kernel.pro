...
pro generate_kernel, psf_target_filename, psf_origin_filename, output_filename 
  psf_target=readfits(psf_target_filename,h1)
  psf_origin=readfits(psf_origin_filename,h2)
  for i=1,100 do begin
	Max_Entropy, psf_target/total(psf_target), psf_origin/total(psf_origin), image_deconv, multipliers, logmin=1.e-9
  endfor
writefits,output_filename,image_deconv
